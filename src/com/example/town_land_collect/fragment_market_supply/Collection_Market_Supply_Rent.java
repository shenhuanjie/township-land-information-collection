...
public class Collection_Market_Supply_Rent extends Fragment implements OnClickListener, OnTouchListener {
	...
	private EditText edit_nzq;// 拟租期
	private EditText edit_nczmj;// 拟土地出租面积
	private Spinner edit_czqyt;// 出租前用途
	private Spinner edit_nczhyt;// 拟出租后用途
	private EditText edit_tdsynq;// 土地剩余使用年期
	private EditText edit_nzj;// 拟年租金
	private EditText edit_yj;// 拟押金
	private EditText edit_sf;// 拟税费
	...
	private String value_nzq;// 拟租期
	private String value_nczmj;// 拟土地出租面积
	private String value_czqyt;// 出租前用途
	private String value_nczhyt;// 拟出租后用途
	private String value_tdsynq;// 土地剩余使用年期
	private String value_nzj;// 拟年租金
	private String value_yj;// 拟押金
	private String value_sf;// 拟税费
	...
	private ArrayList<String> list_nczhyt = new ArrayList<String>();// 拟出租后用途
	/** 其他信息 .Spinner **/
	...
	private void initView(View view) {
		...
		textView_Tips.setText("土地使用权出租供应信息");
	}
	...
	private void initEditText(View view) {
		...
		edit_nzq = (EditText) view.findViewById(R.id.edit_nzq);// 拟租期
		edit_nczmj = (EditText) view.findViewById(R.id.edit_nczmj);// 拟土地出租面积
		edit_czqyt = (Spinner) view.findViewById(R.id.edit_czqyt);// 出租前用途
		edit_nczhyt = (Spinner) view.findViewById(R.id.edit_nczhyt);// 拟出租后用途
		edit_tdsynq = (EditText) view.findViewById(R.id.edit_tdsynq);// 土地剩余使用年期
		edit_nzj = (EditText) view.findViewById(R.id.edit_nzj);// 拟年租金
		edit_yj = (EditText) view.findViewById(R.id.edit_yj);// 拟押金
		edit_sf = (EditText) view.findViewById(R.id.edit_sf);// 拟税费
		/** 位置信息 **/
	...
	private void initSpinnerDict() {
		...
		list_nczhyt = typeUtil.initList("ytlx");// 拟出租后用途
	...
	public void onClick(View arg0) {
		...
		case R.id.fragment_collection_ibtn_save:
			...
			if (edit_x.getText().toString().equals("") || edit_y.getText().toString().equals("")) {
				...
				locationInfo.setCollectionTableName(CollectType.Collection_Market_Supply_Rent_Tablename);// 表名
				// 存储的实体类型
	...
	private void setCollectionInfo() {
		...
		value_nzq = edit_nzq.getText().toString();// 拟租期
		value_nczmj = edit_nczmj.getText().toString();// 拟土地出租面积
		value_tdsynq = edit_tdsynq.getText().toString();// 土地剩余使用年期
		value_nzj = edit_nzj.getText().toString();// 拟年租金
		value_yj = edit_yj.getText().toString();// 拟押金
		value_sf = edit_sf.getText().toString();// 拟税费
	...
	private int saveCollectionInfo() {
		...
		model.setNZQ(value_nzq);// 拟租期
		model.setNCZMJ(value_nczmj);// 拟土地出租面积
		model.setCZQYT(value_czqyt);// 出租前用途
		model.setNCZHYT(value_nczhyt);// 拟出租后用途
		model.setTDSYNQ(value_tdsynq);// 土地剩余使用年期
		model.setNZJ(value_nzj);// 拟年租金
		model.setYJ(value_yj);// 拟押金
		model.setSF(value_sf);// 拟税费
		/** 位置信息 **/
		...
		/** 土地使用权出租供应信息 **/
		model.setIndex_czqyt(index_czqyt);// 出租前用途
		model.setIndex_nczhyt(index_nczhyt);// 拟出租后用途
