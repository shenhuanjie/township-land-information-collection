 ...
 * 
 */
public class EditCollectionMarketMonitorLandValueActivity extends ActionBarActivity implements OnClickListener, OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.collection_market_monitor_land_value_frame_detail);
		/** 初始化控件 **/
		initView();
		initEditText();
		/** 初始化变量 **/
	...
	private void initView() {
		...
		text_tips.setText("土地区段信息");// TODO 修改提示信息
	}
	...
	private void initModel() {
		...
		if (model != null) {
			...
			/** 地价区段信息 **/
			setEditText(R.id.edit_bsm, "BSM", model.getBSM());// 标识码
			setEditText(R.id.edit_qdbh, "QDBH", model.getQDBH());// 区段编号
			setEditText(R.id.edit_qdmc, "QDMC", model.getQDMC());// 区段名称
			setEditText(R.id.edit_qdwz, "QDWZ", model.getQDWZ());// 区段位置
			setEditText(R.id.edit_ytlx, "YTLX", model.getYTLX());// 业态类型
			setEditText(R.id.edit_tdjb, "TDJB", model.getTDJB());// 土地级别
			setEditText(R.id.edit_qdmj, "QDMJ", model.getQDMJ());// 区段面积
			setEditText(R.id.edit_sjytmj, "SJYTMJ", model.getSJYTMJ());// 实际用途面积
			setEditText(R.id.edit_qdjcsszk, "QDJCSSZK", model.getQDJCSSZK());// 区段基础设施状况
			setEditText(R.id.edit_qdggsszk, "QDGGSSZK", model.getQDGGSSZK());// 区段公共公用设施状况
			setEditText(R.id.edit_dz, "DZ", model.getDZ());// 东至
			setEditText(R.id.edit_nz, "NZ", model.getNZ());// 南至
			setEditText(R.id.edit_xz, "XZ", model.getXZ());// 西至
			setEditText(R.id.edit_bz, "BZ", model.getBZ());// 北至
			setEditText(R.id.edit_qd, "QD", model.getQD());// 商服路线起点
			setEditText(R.id.edit_zd, "ZD", model.getZD());// 商服路线止点
			setEditText(R.id.edit_xzrjl, "XZRJL", model.getXZRJL());// 现状容积率
			setEditText(R.id.edit_zysylx, "ZYSYLX", model.getZYSYLX());// 主要商服类型
			setEditText(R.id.edit_jcnf, "JCNF", model.getJCNF());// 建成年份及建筑物状况
			setEditText(R.id.edit_xszgzj, "XSZGZJ", model.getXSZGZJ());// 现时最高年租金
			setEditText(R.id.edit_xspjzj, "XSPJZJ", model.getXSPJZJ());// 现时平均年租金
			setEditText(R.id.edit_xszdzj, "XSZDZJ", model.getXSZDZJ());// 现时最低年租金
			setEditText(R.id.edit_xszgsj, "XSZGSJ", model.getXSZGSJ());// 现时最高售价
			setEditText(R.id.edit_xspjsj, "XSPJSJ", model.getXSPJSJ());// 现时平均售价
			setEditText(R.id.edit_xszdsj, "XSZDSJ", model.getXSZDSJ());// 现时最低售价
			setEditText(R.id.edit_jzr, "JZR", model.getJZR());// 评估基准日
			setEditText(R.id.edit_sdnq, "SDNQ", model.getSDNQ());// 设定年期
			setEditText(R.id.edit_sdrjl, "SDRJL", model.getSDRJL());// 设定容积率
			setEditText(R.id.edit_sdkfsp, "SDKFSP", model.getSDKFSP());// 设定开发水平
			setEditText(R.id.edit_sylxbzsd, "SYLXBZSD", model.getSYLXBZSD());// 商业路线标准深度
			setEditText(R.id.edit_dmjzdj, "DMJZDJ", model.getDMJZDJ());// 地面基准地价
			setEditText(R.id.edit_lmjzdj, "LMJZDJ", model.getLMJZDJ());// 楼面基准地价
	...
	public void onClick(View arg0) { // TODO
		...
		case R.id.fragment_collection_ibtn_save:
			...
			if (edit_x.getText().toString().equals("") || edit_y.getText().toString().equals("")) {
				...
				locationInfo.setCollectionType(CollectType.Collection_Market_Monitor_Land_Value);// TODO
				// 存储的实体类型
				/*
