 ...
 * 
 */
public class EditCollectionMarketMonitorLandLevelActivity extends ActionBarActivity implements OnClickListener, OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.collection_market_monitor_land_level_frame_detail);
		/** 初始化控件 **/
		initView();
		initEditText();
		/** 初始化变量 **/
	...
	private void initView() {
		...
		text_tips.setText("土地级别信息");// TODO 修改提示信息
	}
	...
	private void initModel() {
		ModelCollectionMarketMonitorLandLevel model = DataSupport.find(ModelCollectionMarketMonitorLandLevel.class,
		...
		if (model != null) {
			...
			setEditText(R.id.edit_sdql, "SDQL", model.getSDQL());// 设定权利状况
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.edit_collection_market_monitor_land_level, menu);
		return true;
	}
	...
	public void onClick(View arg0) { // TODO
		...
		case R.id.fragment_collection_ibtn_save:
			...
			if (edit_x.getText().toString().equals("") || edit_y.getText().toString().equals("")) {
				...
				locationInfo.setCollectionType(CollectType.Collection_Market_Monitor_Land_Level);// TODO
																									// 存储的实体类型
				/*
