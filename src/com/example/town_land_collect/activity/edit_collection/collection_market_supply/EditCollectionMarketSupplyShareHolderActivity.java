 ...
 * 
 */
public class EditCollectionMarketSupplyShareHolderActivity extends ActionBarActivity implements OnClickListener, OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.collection_market_supply_share_holder_frame_detail);
		/** 初始化控件 **/
		initView();
		initEditText();
		/** 初始化变量 **/
	...
	private void initView() {
		...
		text_tips.setText("土地联营入股供应信息");// TODO 修改提示信息
	}
	...
	private void initModel() {
		ModelCollectionMarketSupplyShareHolder model = DataSupport.find(ModelCollectionMarketSupplyShareHolder.class,
		...
		if (model != null) {
			...
			setEditText(R.id.edit_nlysj, "NLYSJ", model.getNLYSJ());// 拟联营时间
			setEditText(R.id.edit_nlyq, "NLYQ", model.getNLYQ());// 拟联营期
			setEditText(R.id.edit_ncdmj, "NCDMJ", model.getNCDMJ());// 拟出地方投入土地面积
			setEditText(R.id.edit_nczze, "NCZZE", model.getNCZZE());// 拟出资方投入资金总额
			setEditText(R.id.edit_ncdffcbl, "NCDFFCBL", model.getNCDFFCBL());// 拟出地方利润分成比例
			...
			setEditText(R.id.edit_lyhghyt, "LYHGHYT", model.getLYHGHYT());// 联营后规划用途
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.edit_collection_market_supply_share_holder, menu);
		return true;
	}
