 ...
 * 
 */
public class EditCollectionMarketSupplyHouseRentActivity extends ActionBarActivity implements OnClickListener, OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.collection_market_supply_house_rent_frame_detail);
		/** 初始化控件 **/
		initView();
		initEditText();
		/** 初始化变量 **/
	...
	private void initView() {
		...
		text_tips.setText("房地出租供应信息");// TODO 修改提示信息
	}
	...
	private void initModel() {
		ModelCollectionMarketSupplyHouseRent model = DataSupport.find(ModelCollectionMarketSupplyHouseRent.class,
		...
		if (model != null) {
			...
			/** 房地出租供应信息 **/
			setEditText(R.id.edit_tdsyz, "TDSYZ", model.getTDSYZ());// 土地使用者
			setEditText(R.id.edit_tdzsh, "TDZSH", model.getTDZSH());// 土地证书号
			setEditText(R.id.edit_tdzl, "TDZL", model.getTDZL());// 土地坐落
			setEditText(R.id.edit_fwsyqr, "FWSYQR", model.getFWSYQR());// 房屋所有权人
			setEditText(R.id.edit_qsxz, "QSXZ", model.getQSXZ());// 权属性质
			setEditText(R.id.edit_czf, "CZF", model.getCZF());// 出租方
			setEditText(R.id.edit_fdsynq, "FDSYNQ", model.getFDSYNQ());// 房地剩余使用年期
			setEditText(R.id.edit_tdyt, "TDYT", model.getTDYT());// 土地用途
			setEditText(R.id.edit_ljkd, "LJKD", model.getLJKD());// 临街宽度
			setEditText(R.id.edit_ljsd, "LJSD", model.getLJSD());// 临街深度
			setEditText(R.id.edit_jzlx, "JZLX", model.getJZLX());// 建筑类型
			setEditText(R.id.edit_jzcs, "JZCS", model.getJZCS());// 建筑层数
			setEditText(R.id.edit_fwjg, "FWJG", model.getFWJG());// 房屋结构
			setEditText(R.id.edit_jgsj, "JGSJ", model.getJGSJ());// 竣工时间
			setEditText(R.id.edit_fwcxd, "FWCXD", model.getFWCXD());// 房屋成新度
			setEditText(R.id.edit_zxsj, "ZXSJ", model.getZXSJ());// 装修时间
			setEditText(R.id.edit_zxcd, "ZXCD", model.getZXCD());// 装修程度
			setEditText(R.id.edit_zzhx, "ZZHX", model.getZZHX());// 住宅户型
			setEditText(R.id.edit_ptss, "PTSS", model.getPTSS());// 配套设施
			setEditText(R.id.edit_zbjt, "ZBJT", model.getZBJT());// 周边交通
			setEditText(R.id.edit_nczlc, "NCZLC", model.getNCZLC());// 拟出租楼层
			setEditText(R.id.edit_nczhyt, "NCZHYT", model.getNCZHYT());// 拟出租用途
			setEditText(R.id.edit_nczmj, "NCZMJ", model.getNCZMJ());// 拟出租建筑面积
			setEditText(R.id.edit_nczsj, "NCZSJ", model.getNCZSJ());// 拟出租时间
			setEditText(R.id.edit_nzq, "NZQ", model.getNZQ());// 拟租期(年)
			setEditText(R.id.edit_nzj, "NZJ", model.getNZJ());// 拟年租金
			setEditText(R.id.edit_nyj, "NYJ", model.getNYJ());// 拟押金
			setEditText(R.id.edit_nsf, "NSF", model.getNSF());// 拟税费
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.edit_collection_market_supply_house_rent, menu);
		return true;
	}
