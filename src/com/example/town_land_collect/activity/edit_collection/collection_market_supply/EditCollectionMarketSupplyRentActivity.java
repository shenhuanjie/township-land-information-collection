 ...
 * 
 */
public class EditCollectionMarketSupplyRentActivity extends ActionBarActivity implements OnClickListener, OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.collection_market_supply_rent_out_frame_detail);
		/** 初始化控件 **/
		initView();
		initEditText();
		/** 初始化变量 **/
	...
	private void initView() {
		...
		text_tips.setText("土地使用权出租供应信息");// TODO 修改提示信息
	}
	...
	private void initModel() {
		ModelCollectionMarketSupplyRent model = DataSupport.find(ModelCollectionMarketSupplyRent.class, locationInfo.getCollectionId());
		if (model != null) {
			/** 基本信息 **/
			...
			setEditText(R.id.edit_nzq, "NZQ", model.getNZQ());// 拟租期
			setEditText(R.id.edit_nczmj, "NCZMJ", model.getNCZMJ());// 拟土地出租面积
			setEditText(R.id.edit_czqyt, "CZQYT", model.getCZQYT());// 出租前用途
			setEditText(R.id.edit_nczhyt, "NCZHYT", model.getNCZHYT());// 拟出租后用途
			setEditText(R.id.edit_tdsynq, "TDSYNQ", model.getTDSYNQ());// 土地剩余使用年期
			setEditText(R.id.edit_nzj, "NZJ", model.getNZJ());// 拟年租金
			setEditText(R.id.edit_yj, "YJ", model.getYJ());// 拟押金
			setEditText(R.id.edit_sf, "SF", model.getSF());// 拟税费
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.edit_collection_market_supply_rent, menu);
		return true;
	}
