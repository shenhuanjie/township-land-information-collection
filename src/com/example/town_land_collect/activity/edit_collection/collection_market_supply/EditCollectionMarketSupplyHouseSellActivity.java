...
public class EditCollectionMarketSupplyHouseSellActivity extends ActionBarActivity implements OnClickListener, OnTouchListener {
	...
	private void initView() {
		...
		text_tips.setText("房地出让供应信息");// TODO 修改提示信息
	}
	...
	private void initModel() {
		...
		if (model != null) {
			...
			setEditText(R.id.edit_tdzsh, "TDZSH", model.getTDZSH());// 土地证书号
			setEditText(R.id.edit_yszsh, "YSZSH", model.getYSZSH());// 预售证书号
			setEditText(R.id.edit_tdzl, "TDZL", model.getTDZL());// 土地坐落
			setEditText(R.id.edit_qsxz, "QSXZ", model.getQSXZ());// 权属性质
			setEditText(R.id.edit_fdsynq, "FDSYNQ", model.getFDSYNQ());// 房地剩余使用年期
			setEditText(R.id.edit_sfesf, "SFESF", model.getSFESF());// 是否二手房
			setEditText(R.id.edit_sfzaj, "SFZAJ", model.getSFZAJ());// 是否转按揭
			setEditText(R.id.edit_cczt, "CCZT", model.getCCZT());// 出租状态
			setEditText(R.id.edit_dyzt, "DYZT", model.getDYZT());// 抵押状态
			...
			setEditText(R.id.edit_ncslc, "NCSLC", model.getNCSLC());// 拟出售楼层
			setEditText(R.id.edit_ncsyt, "NCSYT", model.getNCSYT());// 拟出售用途
			setEditText(R.id.edit_ncsmj, "NCSMJ", model.getNCSMJ());// 拟出售建筑面积
			setEditText(R.id.edit_ncssj, "NCSSJ", model.getNCSSJ());// 拟出售时间
			setEditText(R.id.edit_ndwmjsj, "NDWMJSJ", model.getNDWMJSJ());// 拟单位面积售价
			setEditText(R.id.edit_nsj, "NSJ", model.getNSJ());// 拟售价
