 ...
 * 
 */
public class EditCollectionMarketSupplySellActivity extends ActionBarActivity implements OnClickListener, OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.collection_market_supply_sell_frame_detail);
		/** 初始化控件 **/
		initView();
		initEditText();
		/** 初始化变量 **/
	...
	private void initView() {
		...
		text_tips.setText("土地使用权出让供应信息");// TODO 修改提示信息
	}
	...
	private void initModel() {
		ModelCollectionMarketSupplySell model = DataSupport.find(ModelCollectionMarketSupplySell.class, locationInfo.getCollectionId());
		if (model != null) {
			/** 基本信息 **/
			...
			setEditText(R.id.edit_zdbh, "ZDBH", model.getZDBH());// 宗地编号
			setEditText(R.id.edit_tdzl, "TDZL", model.getTDZL());// 土地坐落
			setEditText(R.id.edit_qsxz, "QSXZ", model.getQSXZ());// 权属性质
			setEditText(R.id.edit_ncrsj, "NCRSJ", model.getNCRSJ());// 拟出让时间
			setEditText(R.id.edit_crfs, "CRFS", model.getCRFS());// 拟出让方式
			setEditText(R.id.edit_ncrnq, "NCRNQ", model.getNCRNQ());// 拟出让年期
			setEditText(R.id.edit_sfzkf, "SFZKF", model.getSFZKF());// 是否再开发
			setEditText(R.id.edit_sflyd, "SFLYD", model.getSFLYD());// 是否留用地
			setEditText(R.id.edit_ghtdmj, "GHTDMJ", model.getGHTDMJ());// 规划红线范围土地面积
			setEditText(R.id.edit_ndztdmj, "NDZTDMJ", model.getNDZTDMJ());// 拟代征土地面积
			setEditText(R.id.edit_crqyt, "CRQYT", model.getCRQYT());// 出让前用途
			setEditText(R.id.edit_crhghyt, "CRHGHYT", model.getCRHGHYT());// 出让后规划用途
			setEditText(R.id.edit_ncrdj, "NCRDJ", model.getNCRDJ());// 拟单位面积土地出让价
			setEditText(R.id.edit_ncrzj, "NCRZJ", model.getNCRZJ());// 拟土地出让总价

			/** 其他信息 **/
			setEditText(R.id.edit_ghrjl, "GHRJL", model.getGHRJL());// 规划宗地容积率
			setEditText(R.id.edit_hxwkfsp, "GHHXWKFSP", model.getGHHXWKFSP());// 规划红线外开发水平
			setEditText(R.id.edit_hxnkfsp, "GHHXNKFSP", model.getGHHXNKFSP());// 规划红线内开发水平
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.edit_collection_market_supply_sell, menu);
		return true;
	}
