 ...
 * 
 */
public class EditCollectionMarketDemandHouseSellActivity extends ActionBarActivity implements OnClickListener, OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.collection_market_demand_house_sell_frame_detail);
		/** 初始化控件 **/
		initView();
		initEditText();
		/** 初始化变量 **/
	...
	private void initView() {
		...
		image_photo.setOnClickListener(this);// TODO 图片选择按钮控件
		...
		text_tips.setText("房地出售需求信息");// TODO 修改提示信息
	}
	...
	private void initModel() {
		ModelCollectionMarketDemandHouseSell model = DataSupport.find(ModelCollectionMarketDemandHouseSell.class,
		...
		if (model != null) {
			...
			/** 房地出售需求信息 **/
			setEditText(R.id.edit_xqgmf, "XQGMF", model.getXQGMF());// 需求购买方
			setEditText(R.id.edit_ntdzl, "NTDZL", model.getNTDZL());// 拟土地坐落
			setEditText(R.id.edit_nqsxz, "NQSXZ", model.getNQSXZ());// 拟权属性质
			setEditText(R.id.edit_sfesf, "SFESF", model.getSFESF());// 是否二手房
			setEditText(R.id.edit_sfzajf, "SFZAJF", model.getSFZAJF());// 是否转按揭房
			setEditText(R.id.edit_tdsyknq, "TDSYKNQ", model.getTDSYKNQ());// 土地剩余使用年期
			setEditText(R.id.edit_ntdyt, "NTDYT", model.getNTDYT());// 拟土地用途
			setEditText(R.id.edit_xqgmsj, "XQGMSJ", model.getXQGMSJ());// 需求购买时间
			setEditText(R.id.edit_xqcsmj, "XQCSMJ", model.getXQCSMJ());// 需求购买建筑面积
			setEditText(R.id.edit_xqksymjyq, "XQKSYMJYQ", model.getXQKSYMJYQ());// 需求可使用面积
			setEditText(R.id.edit_xqrjl, "XQRJL", model.getXQRJL());// 需求容积率
			setEditText(R.id.edit_xqljkd, "XQLJKD", model.getXQLJKD());// 需求临街宽度
			setEditText(R.id.edit_xqljsd, "XQLJSD", model.getXQLJSD());// 需求临街深度
			setEditText(R.id.edit_xqjzlx, "XQJZLX", model.getXQJZLX());// 需求建筑类型
			setEditText(R.id.edit_xqjzcs, "XQJZCS", model.getXQJZCS());// 需求建筑层数
			setEditText(R.id.edit_xqfwjg, "XQFWJG", model.getXQFWJG());// 需求房屋结构
			setEditText(R.id.edit_xqjgsj, "XQJGSJ", model.getXQJGSJ());// 需求竣工时间
			setEditText(R.id.edit_xqfwcxd, "XQFWCXD", model.getXQFWCXD());// 需求房屋成新度
			setEditText(R.id.edit_xqzxsj, "XQZXSJ", model.getXQZXSJ());// 需求装修时间
			setEditText(R.id.edit_xqzxcd, "XQZXCD", model.getXQZXCD());// 需求装修程度
			setEditText(R.id.edit_xqzzhx, "XQZZHX", model.getXQZZHX());// 需求住宅户型
			setEditText(R.id.edit_xqptss, "XQPTSS", model.getXQPTSS());// 需求配套设施
			setEditText(R.id.edit_xqzbjt, "XQZBJT", model.getXQZBJT());// 需求周边交通
			setEditText(R.id.edit_xqdwmjsj, "XQDWMJSJ", model.getXQDWMJSJ());// 需求单位面积售价
			setEditText(R.id.edit_xqzsj, "XQZSJ", model.getXQZSJ());// 需求总售价
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.edit_collection_market_demand_house_sell, menu);
		return true;
	}
	...
	public void onClick(View arg0) { // TODO
		...
		case R.id.fragment_collection_ibtn_save:
			...
			if (edit_x.getText().toString().equals("") || edit_y.getText().toString().equals("")) {
				...
				locationInfo.setCollectionType(CollectType.Collection_Market_Demand_House_Sell);// TODO
																								// 存储的实体类型
				/*
