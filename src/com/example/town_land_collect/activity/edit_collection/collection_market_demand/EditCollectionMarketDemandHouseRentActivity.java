 ...
 * 
 */
public class EditCollectionMarketDemandHouseRentActivity extends ActionBarActivity implements OnClickListener, OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.collection_market_demand_house_rent_frame_detail);
		/** 初始化控件 **/
		initView();
		initEditText();
		/** 初始化变量 **/
	...
	private void initView() {
		...
		text_tips.setText("房地出租需求信息");// TODO 修改提示信息
	}
	...
	private void initModel() {
		...
		if (model != null) {
			...
			/** 房地出租需求信息 **/
			setEditText(R.id.edit_xqczf, "XQCZF", model.getXQCZF());// 需求承租方
			setEditText(R.id.edit_ntdzl, "NTDZL", model.getNTDZL());// 拟土地坐落
			setEditText(R.id.edit_nqsxz, "NQSXZ", model.getNQSXZ());// 拟权属性质
			setEditText(R.id.edit_tdsynq, "TDSYNQ", model.getTDSYNQ());// 土地剩余使用年期
			...
			setEditText(R.id.edit_ljsd, "LJSD", model.getLJSD());// 临街深度
			...
			setEditText(R.id.edit_jgsj, "JGSJ", model.getJGSJ());// 竣工时间
			setEditText(R.id.edit_xqfwcxd, "XQFWCXD", model.getXQFWCXD());// 需求房屋成新度
			setEditText(R.id.edit_zxsj, "ZXSJ", model.getZXSJ());// 装修时间
			setEditText(R.id.edit_xqzxcd, "XQZXCD", model.getXQZXCD());// 需求装修程度
			setEditText(R.id.edit_xqczlc, "XQCZLC", model.getXQCZLC());// 需求出租楼层
			setEditText(R.id.edit_xqczyt, "XQCZYT", model.getXQCZYT());// 需求出租用途
			setEditText(R.id.edit_xqczmj, "XQCZMJ", model.getXQCZMJ());// 需求出租建筑面积
			setEditText(R.id.edit_xqczsj, "XQCZSJ", model.getXQCZSJ());// 需求出租时间
			setEditText(R.id.edit_xqzq, "XQZQ", model.getXQZQ());// 需求租期（年）
			setEditText(R.id.edit_xqhx, "XQHX", model.getXQHX());// 需求住宅户型
			setEditText(R.id.edit_xqptss, "XQPTSS", model.getXQPTSS());// 需求配套设施
			setEditText(R.id.edit_xqzbjt, "XQZBJT", model.getXQZBJT());// 需求周边交通
			setEditText(R.id.edit_xqnzj, "XQNZJ", model.getXQNZJ());// 需求年租金
			setEditText(R.id.edit_nyj, "NYJ", model.getNYJ());// 拟押金
	...
	public void onClick(View arg0) { // TODO
		...
		case R.id.fragment_collection_ibtn_save:
			...
			if (edit_x.getText().toString().equals("") || edit_y.getText().toString().equals("")) {
				...
				locationInfo.setCollectionType(CollectType.Collection_Market_Demand_House_Rent);// TODO
																								// 存储的实体类型
				/*
