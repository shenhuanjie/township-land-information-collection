...
public class EditCollectionMarketDemandRentActivity extends ActionBarActivity implements OnClickListener, OnTouchListener {
	...
	private void initView() {
		...
		text_tips.setText("土地使用权出租需求信息");// TODO 修改提示信息
	}
	...
	private void initModel() {
		...
		if (model != null) {
			...
			setEditText(R.id.edit_xqczfztxz, "XQCZFZTXZ", model.getXQCZFZTXZ());// 需求承租方主体性质
			...
			setEditText(R.id.edit_xqzq, "XQZQ", model.getXQZQ());// 需求租期
			setEditText(R.id.edit_xqczmj, "XQCZMJ", model.getXQCZMJ());// 需求土地出租面积
			setEditText(R.id.edit_czqyt, "CZQYT", model.getCZQYT());// 出租前用途
			setEditText(R.id.edit_nczyt, "NCZYT", model.getNCZYT());// 拟出租后用途
			setEditText(R.id.edit_tdsynq, "TDSYNQ", model.getTDSYNQ());// 土地剩余使用年期
			setEditText(R.id.edit_rjl, "RJL", model.getRJL());// 宗地容积率
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.edit_collection_market_demand_rent, menu);
		return true;
	}
