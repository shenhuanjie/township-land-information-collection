 ...
 * 
 */
public class EditCollectionMarketRedevelopmentImposeActivity extends ActionBarActivity implements OnClickListener, OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.collection_market_redevelopment_impose_frame_detail);
		/** 初始化控件 **/
		initView();
		initEditText();
		/** 初始化变量 **/
	...
	private void initView() {
		...
		text_tips.setText("再开发实施项目信息");// TODO 修改提示信息
	}
	...
	private void initModel() {
		ModelCollectionMarketRedevelopmentImpose model = DataSupport.find(ModelCollectionMarketRedevelopmentImpose.class,
		...
		if (model != null) {
			...
			setEditText(R.id.edit_xmlx, "XMLX", model.getXMLX());// 项目类型
			...
			setEditText(R.id.edit_jzmd, "JZMD", model.getJZMD());// 建筑密度
			setEditText(R.id.edit_lvh, "LVH", model.getLVH());// 绿化率
			setEditText(R.id.edit_kfms, "KFMS", model.getKFMS());// 开发模式
			setEditText(R.id.edit_ztz, "ZTZ", model.getZTZ());// 总投资
			setEditText(R.id.edit_zjly, "ZJLY", model.getZJLY());// 资金来源
			setEditText(R.id.edit_gdfs, "GDFS", model.getGDFS());// 供地方式
			setEditText(R.id.edit_kfqyt, "KFQYT", model.getKFQYT());// 开发前用途
			setEditText(R.id.edit_kfhyt, "KFHYT", model.getKFHYT());// 开发后用途
			setEditText(R.id.edit_cylx, "CYLX", model.getCYLX());// 产业类型
			...
			setEditText(R.id.edit_djcyry, "DJCYRY", model.getDJCYRY());// 地均从业人员数
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.edit_collection_market_redevelopment_impose, menu);
		return true;
	}
	...
	public void onClick(View arg0) { // TODO
		...
		case R.id.fragment_collection_ibtn_save:
			...
			if (edit_x.getText().toString().equals("") || edit_y.getText().toString().equals("")) {
				...
				locationInfo.setCollectionType(CollectType.Collection_Market_Redevelopment_Impose);// TODO
																									// 存储的实体类型
				/*
