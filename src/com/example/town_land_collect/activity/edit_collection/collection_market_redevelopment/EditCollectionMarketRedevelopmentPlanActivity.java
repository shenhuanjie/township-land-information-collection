package com.example.town_land_collect.activity.edit_collection.collection_market_redevelopment;
 ...
 * 
 */
public class EditCollectionMarketRedevelopmentPlanActivity extends ActionBarActivity implements OnClickListener, OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.collection_market_redevelopment_plan_frame_detail);
		/** 初始化控件 **/
		initView();
		initEditText();
		/** 初始化变量 **/
	...
	private void initView() {
		...
		text_tips.setText("再开发计划项目信息");// TODO 修改提示信息
	}
	...
	private void initModel() {
		ModelCollectionMarketRedevelopmentPlan model = DataSupport.find(ModelCollectionMarketRedevelopmentPlan.class,
		...
		if (model != null) {
			...
			/** 再开发计划项目信息 **/
			setEditText(R.id.edit_bh, "BH", model.getBH());// 编号
			setEditText(R.id.edit_xmmc, "XMMC", model.getXMMC());// 项目名称
			...
			setEditText(R.id.edit_ghyt, "GHYT", model.getGHYT());// 规划用途
			setEditText(R.id.edit_ghrjl, "GHRJL", model.getGHRJL());// 规划容积率
			setEditText(R.id.edit_ghjzxs, "GHJZXS", model.getGHJZXS());// 规划建筑系数
			setEditText(R.id.edit_ghjzmd, "GHJZMD", model.getGHJZMD());// 规划建筑密度
			setEditText(R.id.edit_ghlvh, "GHLVH", model.getGHLVH());// 规划绿化率
			setEditText(R.id.edit_nkfms, "NKFMS", model.getNKFMS());// 拟开发模式
			setEditText(R.id.edit_yjztz, "YJZTZ", model.getYJZTZ());// 预计总投资
			setEditText(R.id.edit_zjly, "ZJLY", model.getZJLY());// 资金来源
			setEditText(R.id.edit_ngdfs, "NGDFS", model.getNGDFS());// 拟供地方式
			setEditText(R.id.edit_cylx, "CYLX", model.getCYLX());// 规划产业类型
			setEditText(R.id.edit_qyzdcy, "QYZDCY", model.getQYZDCY());// 区域主导产业类型
			setEditText(R.id.edit_qygyjzdj, "QYGYJZDJ", model.getQYGYJZDJ());// 区域国有建设用地基准地价
			setEditText(R.id.edit_qyjtjzdj, "QYJTJZDJ", model.getQYJTJZDJ());// 区域集体建设用地基准地价
			setEditText(R.id.edit_yjdjcz, "YJDJCZ", model.getYJDJCZ());// 预计地均产值
			setEditText(R.id.edit_yjdjss, "YJDJSS", model.getYJDJSS());// 预计地均税收
			setEditText(R.id.edit_yjdjcyry, "YJDJCYRY", model.getYJDJCYRY());// 预计地均从业人员数
			setEditText(R.id.edit_qtyqyx, "QTYQYX", model.getQTYQYX());// 其它预期效应
			setEditText(R.id.edit_zfyy, "ZFYY", model.getZFYY());// 政府意愿
			setEditText(R.id.edit_kfsyy, "KFSYY", model.getKFSYY());// 开发商意愿
			setEditText(R.id.edit_tdsyzyy, "TDSYZYY", model.getTDSYZYY());// 土地所有者意愿
			setEditText(R.id.edit_tdshyzyy, "TDSHYZYY", model.getTDSHYZYY());// 土地使用者意愿
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.edit_collection_market_redevelopment_plan, menu);
		return true;
	}
