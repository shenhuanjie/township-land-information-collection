 ...
 * 
 */
public class EditCollectionMarketBusinessHouseSellActivity extends ActionBarActivity implements OnClickListener, OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.collection_market_business_house_sell_frame_detail);
		/** 初始化控件 **/
		initView();
		initEditText();
		/** 初始化变量 **/
	...
	private void initView() {
		...
		text_tips.setText("房地出售交易信息");// TODO 修改提示信息
	}
	...
	private void initModel() {
		ModelCollectionMarketBusinessHouseSell model = DataSupport.find(ModelCollectionMarketBusinessHouseSell.class,
		...
		if (model != null) {
			...
			setEditText(R.id.edit_the_name, "edit_tdzl", model.getTHENAME());// 记录名称
			setEditText(R.id.edit_the_code, "edit_tdzl", model.getTHECODE());// 记录代码
			setEditText(R.id.edit_tdsyz, "edit_tdzl", model.getTDSYZ());// 土地使用者
			setEditText(R.id.edit_tdzsh, "edit_tdzl", model.getTDZSH());// 土地证书号
			setEditText(R.id.edit_tdzl, "edit_tdzl", model.getTDZL());// 土地坐落
			setEditText(R.id.edit_qsxz, "edit_tdzl", model.getQSXZ());// 权属性质

			/** 房地出售交易信息 **/
			setEditText(R.id.edit_fwsyqr, "edit_tdzl", model.getFWSYQR());// 房屋所有权人
			setEditText(R.id.edit_tdyt, "edit_tdzl", model.getTDYT());// 土地用途
			setEditText(R.id.edit_ljkd, "edit_tdzl", model.getLJKD());// 临街宽度
			setEditText(R.id.edit_ljsd, "edit_tdzl", model.getLJSD());// 临街深度
			setEditText(R.id.edit_jzlx, "edit_tdzl", model.getJZLX());// 建筑类型
			setEditText(R.id.edit_jzcs, "edit_tdzl", model.getJZCS());// 建筑层数
			setEditText(R.id.edit_fwjg, "edit_tdzl", model.getFWJG());// 房屋结构
			setEditText(R.id.edit_jgsj, "edit_tdzl", model.getJGSJ());// 竣工时间
			setEditText(R.id.edit_fwcxd, "edit_tdzl", model.getFWCXD());// 房屋成新度
			setEditText(R.id.edit_zxsj, "edit_tdzl", model.getZXSJ());// 装修时间
			setEditText(R.id.edit_zxcd, "edit_tdzl", model.getZXCD());// 装修程度
			setEditText(R.id.edit_cslc, "edit_tdzl", model.getCSLC());// 出售楼层
			setEditText(R.id.edit_csyt, "edit_tdzl", model.getCSYT());// 出售用途
			setEditText(R.id.edit_csmj, "edit_tdzl", model.getCSMJ());// 出售建筑面积
			setEditText(R.id.edit_cssj, "edit_tdzl", model.getCSSJ());// 出售时间
			setEditText(R.id.edit_sj, "edit_tdzl", model.getSJ());// 售价
			setEditText(R.id.edit_sf, "edit_tdzl", model.getSF());// 税费

			/** 其他信息 **/
			setEditText(R.id.edit_rjl, "edit_tdzl", model.getRJL());// 容积率
			...
			setEditText(R.id.edit_tdjb, "edit_tdzl", model.getTDJB());// 所在土地级别
			setEditText(R.id.edit_djqd, "edit_tdzl", model.getDJQD());// 所在地价区段
			setEditText(R.id.edit_xzqdm, "edit_tdzl", model.getXZQDM());// 行政区代码

			/** 位置信息 **/
			setEditText(R.id.location_info_lon, "edit_tdzl", model.getX());// X坐标
			setEditText(R.id.location_info_lat, "edit_tdzl", model.getY());// Y坐标
			setEditText(R.id.location_info_zbxt, "edit_tdzl", model.getZBXT());// 坐标系统
			setEditText(R.id.location_info_remark, "edit_tdzl", model.getREMARK());// 备注
	...
	private void initEditText() {
		...
		// edit_cslc = (EditText) findViewById(R.id.edit_the_cslc);// 出售楼层
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.edit_collection_market_business_house_sell, menu);
		return true;
	}
