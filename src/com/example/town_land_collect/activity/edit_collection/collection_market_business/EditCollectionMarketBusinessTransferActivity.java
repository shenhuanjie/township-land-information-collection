 ...
 * 
 */
public class EditCollectionMarketBusinessTransferActivity<edit_tdsyz> extends ActionBarActivity implements OnClickListener, OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.collection_market_business_transfer_frame_detail);
	...
	private void initView() {
		...
		text_tips.setText("土地使用权转让交易信息");// TODO 修改提示信息
	}
	...
	private void initModel() {
		...
		if (model != null) {
			...
			setEditText(R.id.edit_srf, "SRF", model.getSRF());// 受让方
			setEditText(R.id.edit_zrsj, "ZRSJ", model.getZRSJ());// 转让时间
			setEditText(R.id.edit_zrfs, "ZRFS", model.getZRFS());// 转让方式
			setEditText(R.id.edit_zrmj, "ZRMJ", model.getZRMJ());// 土地转让面积
			setEditText(R.id.edit_zrqyt, "ZRQYT", model.getZRQYT());// 转让前用途
			setEditText(R.id.edit_zrhyt, "ZRHYT", model.getZRHYT());// 转让后用途
			setEditText(R.id.edit_tdsynq, "TDSYNQ", model.getTDSYNQ());// 土地剩余使用年期
			setEditText(R.id.edit_zrdj, "ZRDJ", model.getZRDJ());// 土地转让单价
			setEditText(R.id.edit_zrzj, "ZRZJ", model.getZRZJ());// 土地转让总价
