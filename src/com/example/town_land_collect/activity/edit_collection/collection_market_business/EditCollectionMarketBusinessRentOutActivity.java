 ...
 * 
 */
public class EditCollectionMarketBusinessRentOutActivity extends ActionBarActivity implements OnClickListener, OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.collection_market_business_rent_out_frame_detail);
		/** 初始化控件 **/
		initView();
		initEditText();
		/** 初始化变量 **/
	...
	private void initView() {
		...
		text_tips.setText("土地使用权出租交易信息");// TODO 修改提示信息
	}
	...
	private void initModel() {
		ModelCollectionMarketBusinessRentOut model = DataSupport.find(ModelCollectionMarketBusinessRentOut.class,
		...
		if (model != null) {
			...
			/** 土地使用权出租交易信息 **/
			setEditText(R.id.edit_chuzf, "CHUZF", model.getCHUZF());// 出租方
			setEditText(R.id.edit_chengzf, "CHENGZF", model.getCHENGZF());// 承租方
			setEditText(R.id.edit_czsj, "CZSJ", model.getCZSJ());// 出租时间
			setEditText(R.id.edit_zq, "ZQ", model.getZQ());// 租期
			setEditText(R.id.edit_czmj, "CZMJ", model.getCZMJ());// 土地出租面积
			setEditText(R.id.edit_czqyt, "CZQYT", model.getCZQYT());// 出租前用途
			setEditText(R.id.edit_czhyt, "CZHYT", model.getCZHYT());// 出租后用途
			setEditText(R.id.edit_tdsynq, "TDSYNQ", model.getTDSYNQ());// 土地剩余使用年
			setEditText(R.id.edit_nzj, "NZJ", model.getNZJ());// 年租金
			setEditText(R.id.edit_yj, "YJ", model.getYJ());// 押金
			setEditText(R.id.edit_sf, "SF", model.getSF());// 税费
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.edit_collection_market_business_rent_out, menu);
		return true;
	}
