...
//	private double lon;
	...
	private void initView(View view) {
		...
		textView_Tips.setText("乡镇社会经济发展信息");// TODO 修改提示信息
	}
	...
	public void onClick(View arg0) {
		...
		case R.id.fragment_collection_ibtn_save:
			...
			locationInfo.setCollectionTableName(CollectType.Collection_Market_Development_Township_Tablename);// 表名
			// 存储的实体类型
