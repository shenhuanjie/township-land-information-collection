...
public class Collection_Market_Demand_Rent extends Fragment implements OnClickListener, OnTouchListener {
	...
	private Spinner edit_xqczfztxz;// 需求承租方主体性质
	...
	private EditText edit_xqzq;// 需求租期
	private EditText edit_xqczmj;// 需求土地出租面积
	private Spinner edit_czqyt;// 出租前用途
	private Spinner edit_nczyt;// 拟出租后用途
	private EditText edit_tdsynq;// 土地剩余使用年期
	private EditText edit_rjl;// 宗地容积率
	...
	private String value_xqczfztxz;// 需求承租方主体性质
	...
	private String value_xqzq;// 需求租期
	private String value_xqczmj;// 需求土地出租面积
	private String value_czqyt;// 出租前用途
	private String value_nczyt;// 拟出租后用途
	private String value_tdsynq;// 土地剩余使用年期
	private String value_rjl;// 宗地容积率
	...
	/** Spinner Dict **/
	private ArrayList<String> list_xqczfztxz = new ArrayList<String>();// 需求承租方主体性质
	...
	private ArrayList<String> list_nczyt = new ArrayList<String>();// 拟出租后用途
	...
	private void initView(View view) {
		...
		textView_Tips.setText("土地使用权出租需求信息");
	}
	...
	private void initEditText(View view) {
		...
		edit_xqczfztxz = (Spinner) view.findViewById(R.id.edit_xqczfztxz);// 需求承租方主体性质
		...
		edit_xqzq = (EditText) view.findViewById(R.id.edit_xqzq);// 需求租期
		edit_xqczmj = (EditText) view.findViewById(R.id.edit_xqczmj);// 需求土地出租面积
		edit_czqyt = (Spinner) view.findViewById(R.id.edit_czqyt);// 出租前用途
		edit_nczyt = (Spinner) view.findViewById(R.id.edit_nczyt);// 拟出租后用途
		edit_tdsynq = (EditText) view.findViewById(R.id.edit_tdsynq);// 土地剩余使用年期
		edit_rjl = (EditText) view.findViewById(R.id.edit_rjl);// 宗地容积率
	...
	private void initSpinnerDict() {
		...
		list_xqczfztxz = typeUtil.initList("tzztxz");// 需求承租方主体性质
		list_nqsxz = typeUtil.initList("qsxz");// 拟权属性质
		list_czqyt = typeUtil.initList("ytlx");// 出租前用途
		list_nczyt = typeUtil.initList("ytlx");// 拟出租后用途
	...
	public void onClick(View arg0) {
		...
		case R.id.fragment_collection_ibtn_save:
			...
			if (edit_x.getText().toString().equals("") || edit_y.getText().toString().equals("")) {
				...
				locationInfo.setCollectionTableName(CollectType.Collection_Market_Demand_Rent_Tablename);// 表名
				// 存储的实体类型
	...
	private void setCollectionInfo() {
		...
		value_xqzq = edit_xqzq.getText().toString();// 需求租期
		value_xqczmj = edit_xqczmj.getText().toString();// 需求土地出租面积
		value_tdsynq = edit_tdsynq.getText().toString();// 土地剩余使用年期
		value_rjl = edit_rjl.getText().toString();// 宗地容积率
	...
	private int saveCollectionInfo() {
		...
		model.setXQCZFZTXZ(value_xqczfztxz);// 需求承租方主体性质
		...
		model.setXQZQ(value_xqzq);// 需求租期
		model.setXQCZMJ(value_xqczmj);// 需求土地出租面积
		model.setCZQYT(value_czqyt);// 出租前用途
		model.setNCZYT(value_nczyt);// 拟出租后用途
