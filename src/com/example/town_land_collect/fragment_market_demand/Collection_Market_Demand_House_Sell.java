...
public class Collection_Market_Demand_House_Sell extends Fragment implements OnClickListener, OnTouchListener {
	...
	private ArrayList<String> list_sfzajf = new ArrayList<String>();// 是否转按揭房
	...
	private ArrayList<String> list_xqzzhx = new ArrayList<String>();// 需求住宅户型
	...
	private void initView(View view) {
		...
		textView_Tips.setText("房地出售需求信息");
	}
	...
	private void initEditText(View view) {
		...
		/** 房地出售需求信息 **/
		edit_xqgmf = (EditText) view.findViewById(R.id.edit_xqgmf);// 需求购买方
		...
		edit_sfzajf = (Spinner) view.findViewById(R.id.edit_sfzajf);// 是否转按揭房
		edit_tdsyknq = (EditText) view.findViewById(R.id.edit_tdsyknq);// 土地剩余使用年期
		edit_ntdyt = (Spinner) view.findViewById(R.id.edit_ntdyt);// 拟土地用途
		edit_xqgmsj = (EditText) view.findViewById(R.id.edit_xqgmsj);// 需求购买时间
		edit_xqcsmj = (EditText) view.findViewById(R.id.edit_xqcsmj);// 需求购买建筑面积
		edit_xqksymjyq = (EditText) view.findViewById(R.id.edit_xqksymjyq);// 需求可使用面积
		...
		edit_xqljsd = (EditText) view.findViewById(R.id.edit_xqljsd);// 需求临街深度
		...
		edit_xqjgsj = (EditText) view.findViewById(R.id.edit_xqjgsj);// 需求竣工时间
		edit_xqfwcxd = (Spinner) view.findViewById(R.id.edit_xqfwcxd);// 需求房屋成新度
		edit_xqzxsj = (EditText) view.findViewById(R.id.edit_xqzxsj);// 需求装修时间
		edit_xqzxcd = (Spinner) view.findViewById(R.id.edit_xqzxcd);// 需求装修程度
		edit_xqzzhx = (Spinner) view.findViewById(R.id.edit_xqzzhx);// 需求住宅户型
		...
		edit_xqdwmjsj = (EditText) view.findViewById(R.id.edit_xqdwmjsj);// 需求单位面积售价
		edit_xqzsj = (EditText) view.findViewById(R.id.edit_xqzsj);// 需求总售价
		/** 位置信息 **/
	...
	private void initSpinnerDict() {
		...
		list_sfzajf = typeUtil.initList("yesno");// 是否转按揭房
		...
		list_xqzzhx = typeUtil.initList("zzhx");// 需求住宅户型
	...
	public void onClick(View arg0) {
		...
		case R.id.fragment_collection_ibtn_save:
			...
			if (edit_x.getText().toString().equals("") || edit_y.getText().toString().equals("")) {
				...
				locationInfo.setCollectionTableName(CollectType.Collection_Market_Demand_House_Sell_Tablename);// 表名
				// 存储的实体类型
	...
	private void setCollectionInfo() {
		...
		/** 房地出售需求信息 **/
		value_xqgmf = edit_xqgmf.getText().toString();// 需求购买方
		value_ntdzl = edit_ntdzl.getText().toString();// 拟土地坐落
		value_tdsyknq = edit_tdsyknq.getText().toString();// 土地剩余使用年期
		value_xqgmsj = edit_xqgmsj.getText().toString();// 需求购买时间
		value_xqcsmj = edit_xqcsmj.getText().toString();// 需求购买建筑面积
		value_xqksymjyq = edit_xqksymjyq.getText().toString();// 需求可使用面积
		value_xqrjl = edit_xqrjl.getText().toString();// 需求容积率
		value_xqljkd = edit_xqljkd.getText().toString();// 需求临街宽度
		value_xqljsd = edit_xqljsd.getText().toString();// 需求临街深度
		value_xqjzcs = edit_xqjzcs.getText().toString();// 需求建筑层数
		value_xqjgsj = edit_xqjgsj.getText().toString();// 需求竣工时间
		value_xqzxsj = edit_xqzxsj.getText().toString();// 需求装修时间
		value_xqzbjt = edit_xqzbjt.getText().toString();// 需求周边交通
		value_xqdwmjsj = edit_xqdwmjsj.getText().toString();// 需求单位面积售价
		value_xqzsj = edit_xqzsj.getText().toString();// 需求总售价
	...
	private int saveCollectionInfo() {
		...
		model.setIndex_sfesf(index_sfesf);// 是否二手房
		model.setIndex_sfzajf(index_sfzajf);// 是否转按揭房
		...
		model.setIndex_xqzzhx(index_xqzzhx);// 需求住宅户型
